...
func request_Cli_AcceptOrder_0(ctx context.Context, marshaler runtime.Marshaler, client CliClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Cli_AcceptOrder_0(ctx context.Context, marshaler runtime.Marshaler, server CliServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq AcceptOrderRequest
	var metadata runtime.ServerMetadata
...
func RegisterCliHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CliServer) error {
	...
	mux.Handle("POST", pattern_Cli_AcceptOrder_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/cliserver.Cli/AcceptOrder", runtime.WithHTTPPathPattern("/AcceptOrder"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Cli_AcceptOrder_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_Cli_AcceptOrder_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterCliHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CliClient) error {
	...
	mux.Handle("POST", pattern_Cli_AcceptOrder_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/cliserver.Cli/AcceptOrder", runtime.WithHTTPPathPattern("/AcceptOrder"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Cli_AcceptOrder_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Cli_AcceptOrder_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"AcceptOrder"}, ""))
)

var (
	forward_Cli_AcceptOrder_0 = runtime.ForwardResponseMessage
)
